...
def make():
  ...
  if ("windows" == base.host_platform()):
    ...
    vs2022_buildtools = "C:/Program Files (x86)/Microsoft Visual Studio/2022/BuildTools"
    if os.path.exists(vs2022_buildtools):
      # V8 8.9 only knows VS2019/2017, but VS2022 Build Tools here includes the v142 toolset.
      base.set_env("vs2019_install", vs2022_buildtools)
      base.set_env("GYP_MSVS_OVERRIDE_PATH", vs2022_buildtools)
  ...
  if not base.is_dir("v8"):
    ...
    if ("windows" == base.host_platform()):
      os.chdir("v8")
      base.cmd("git", ["config", "--global", "core.longpaths", "true"], True)
      os.chdir("../")
  ...
  if ("windows" == base.host_platform()):
    ...
    base.replaceInFile("v8/build/vs_toolchain.py", "('api-ms-win-downlevel-kernel32-l2-1-0.dll', False)", "('api-ms-win-downlevel-kernel32-l2-1-0.dll', True)")
