...
def get_vs_version():
  ...
  if config.option("vs-version") == "2019":
    vs_version = "16 2019"
    if base.is_dir("C:/Program Files (x86)/Microsoft Visual Studio/2022/BuildTools"):
      vs_version = "17 2022"
  return vs_version

def get_vs_toolset():
  if get_vs_version() == "17 2022" and base.is_dir("C:/Program Files (x86)/Microsoft Visual Studio/2022/BuildTools/VC/Tools/MSVC/14.29.30133"):
    return "v142"
  return ""
...
def build_with_cmake(platform, cmake_args, build_type):
  ...
  if "win" in platform:
    ...
    vs_toolset = get_vs_toolset()
    if vs_toolset != "":
      cmake_args_ext += ["-T", vs_toolset]
