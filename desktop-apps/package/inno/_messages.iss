...
en.extDOCXF =VN Office Form Template
en_GB.extDOCXF =VN Office Form Template
ar_SA.extDOCXF =قالب استبيان VN Office
bg.extDOCXF =VN Office Шаблон на формуляр
ca.extDOCXF =Plantilla de formulari VN Office
cs.extDOCXF =Šablona formuláře VN Office
el.extDOCXF =Πρότυπο φόρμας εγγράφου VN Office
;et.extDOCXF =VN Office dokumendi vormi mall
fi.extDOCXF =VN Office-asiakirjalomakemalli
;lt.extDOCXF =VN Office Anketos Šablonas
lo.extDOCXF =ຮູບແບບຂອງ VN Office
nl.extDOCXF =VN Office Formulier Sjabloon
ru.extDOCXF =Шаблон формы VN Office
de.extDOCXF =VN Office-Formularvorlage
fr.extDOCXF =Modèle de formulaire VN Office
es.extDOCXF =Plantilla de formulario VN Office
id.extDOCXF =Templat VN Office Form
it_IT.extDOCXF =Modello di modulo VN Office
pt_BR.extDOCXF =Modelo de formulário do VN Office
pt_PT.extDOCXF =Modelo de formulário VN Office
pl.extDOCXF =Szablon formularza VN Office
ro.extDOCXF =Șablon Formă VN Office
sk.extDOCXF =Šablóna formulára VN Office
sl.extDOCXF =VN Office predloga obrazca
sv.extDOCXF =VN Office formulärmall
tr.extDOCXF =VN Office Belgesi Form Şablonu
vi.extDOCXF =Mẫu biểu mẫu tài liệu VN Office
zh_CN.extDOCXF =VN Office表单模板
hy_AM.extDOCXF =VN Office փաստաթղթի ձևանմուշ
;hr.extDOCXF =VN Office Predložak obrasca
da.extDOCXF =VN Office formularskabelon
;hi.extDOCXF =ओनलीऑफिस दस्तावेज़ फॉर्म टेम्पलेट
hu.extDOCXF =VN Office formátum-sablon
;ga_IE.extDOCXF =Teimpléad Foirm VN Office
ja.extDOCXF =VN Office フォーム テンプレート
ko.extDOCXF =VN Office 문서 양식 템플릿
lv.extDOCXF =VN Office veidlapas veidne
no.extDOCXF =VN Office-dokumentskjemamal
uk.extDOCXF =Шаблон форми VN Office
be.extDOCXF =Шаблон формы VN Office
gl.extDOCXF =VN Office Modelo de Formulario
si.extDOCXF =ඔන්ලිඔෆිස් ආකෘතිපත්‍ර අච්චුව
zh_TW.extDOCXF =VN Office 文档表单模板
sr_Cyrl_RS.extDOCXF =VN Office формулар шаблон
sr_Latn_RS.extDOCXF =VN Office formular šablon
he.extDOCXF =תבנית טופס VN Office
sq.extDOCXF =Modeli i shablloni VN Office
#if Ver >= EncodeVer(6,1,1)
ur.extDOCXF =VN Office فارم ٹیمپلیٹ
#endif
