l10n.fi = {
    welWelcome: 'Tervetuloa VN Office Työpöytä Editoriin!',
    ...
    btnCreatePortal: 'Luo VN Office pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon VN OfficeN pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo VN Office pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa VN OfficeN pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi VN OfficeN pilveen ja käytä niitä million tahansa, missä tahansa.',
