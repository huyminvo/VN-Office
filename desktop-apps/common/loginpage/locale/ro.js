l10n.ro = {
    welWelcome: 'Bine ați venit la VN Office Desktop Editors!',
    ...
    btnCreatePortal: 'Crearea unui cont VN Office cloud',
    ...
    portalEmptyAdv1: 'Încã nu aveți un cont Cloud? Lucrați online cu servicii cloud VN Office ți <br />încercați funcțiile de colaborare gratuit.',
    ...
    linkCreatePortal: 'Crearea unui cont VN Office cloud',
    ...
    loginNoteAssignPhone: 'Autentificarea cu doi factori este activatã ca o mãsurã suplimentarã de securitate pentru VN Office cloud. Intra-i numãrul de telefon dvs vă sã puteţi continua lucrul în oficiul cloud. Numãrul de telefon mobil trebuie introdus în format internaþional cu prefixul de țarã.',
    ...
    emptySlide3Text: 'Stocați-vă documentele în VN Office cloud și le accesati de oriunde, oricând.',
