l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο VN Office Desktop Editors!',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα VN Office cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία VN Office Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός VN Office cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο VN Office cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
