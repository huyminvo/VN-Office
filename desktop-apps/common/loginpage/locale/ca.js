l10n.ca = {
    welWelcome: 'Benvingut/da a VN Office Desktop Editors!',
    ...
    btnCreatePortal: 'Crea un núvol VN Office',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb VN Office Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol VN Office',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de VN Office. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol VN Office i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
