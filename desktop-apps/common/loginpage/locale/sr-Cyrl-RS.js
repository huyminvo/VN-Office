l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у VN Office Десктоп Уређиваче!',
    ...
    btnCreatePortal: 'Креирај VN Office облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са VN Office Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај VN Office облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну VN Office облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у VN Office облаку и приступи им било када, са било ког места.',
