l10n.he = {
    welWelcome: 'ברוכים הבאים לעורכי שולחן העבודה של VN Office!',
    ...
    btnCreatePortal: 'צור ענן VN Office',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם VN Office Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    linkCreatePortal: 'צור ענן VN Office',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של VN Office. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן VN Office וגש אליהם בכל עת ומכל מקום.',
