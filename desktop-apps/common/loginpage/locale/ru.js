l10n.ru = {
    welWelcome: 'Добро пожаловать в VN Office!',
    ...
    btnCreatePortal: 'Создать облако VN Office',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом VN Office и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако VN Office',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке VN Office включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке VN Office и получайте к ним доступ в любое время, из любой точки мира.',
