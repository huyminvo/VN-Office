...
# 🧩 VN Office JavaScript SDK (SDKJS)

SDKJS is the official JavaScript Software Development Kit (SDK) for VN Office document editing components.

JavaScript SDK provides the necessary **client-side APIs** for integrating and customizing the VN Office editors. It also includes an **implementation layer** for the Office JavaScript APIs, enabling advanced document manipulation and integration operations.
...
**SDKJS** is licensed under the **GNU Affero General Public License (AGPL) v3.0**. For full details, refer to the [LICENSE](https://github.com/huymin222/VN-Office/blob/main/LICENSE) file.
