...
void RootWindowWin::CreateRootWindow(const CefBrowserSettings& settings,
  ...
  const std::wstring& window_title = L"ASCDocumentEditor_debug";//GetResourceString(IDS_APP_TITLE);
  const std::wstring& window_class = L"ASCDocumentEditor_debug";//GetResourceString(IDC_CEFCLIENT);
